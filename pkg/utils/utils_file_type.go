...
func init() {
	...
	setFileType("424d228c010000000000", "bmp")  //16-color bitmap (bmp)
	setFileType("424d8240090000000000", "bmp")  //24-bit bitmap (bmp)
	setFileType("424d8e1b030000000000", "bmp")  //256-color bitmap (bmp)
	...
	setFileType("d0cf11e0a1b11ae10000", "vsd")  //Visio drawing
	...
	setFileType("d0cf11e0a1b11ae10000", "doc")          //MS Excel Note: word, msi and excel have the same file header
	...
	setFileType("4d5a9000030000000400", "exe")        //Executable file
	setFileType("3c25402070616765206c", "jsp")        //jsp file
	setFileType("4d616e69666573742d56", "mf")         //MF file
	setFileType("3c3f786d6c2076657273", "xml")        //xml file
	setFileType("494e5345525420494e54", "sql")        //xml file
	setFileType("7061636b616765207765", "java")       //java file
	setFileType("406563686f206f66660d", "bat")        //bat file
	setFileType("1f8b0800000000000000", "gz")         //gz file
	setFileType("6c6f67346a2e726f6f74", "properties") //bat file
	setFileType("cafebabe0000002e0041", "class")      //bat file
...
// Get the binary of the result bytes
